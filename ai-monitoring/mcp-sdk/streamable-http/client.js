...
const { getDisplayName } = require('@modelcontextprotocol/sdk/shared/metadataUtils.js')
...
let notificationsToolLastEventId
let sessionId
...
async function callTool(name, args) {
  ...
  await newrelic.startBackgroundTransaction('callTool', async () => {
